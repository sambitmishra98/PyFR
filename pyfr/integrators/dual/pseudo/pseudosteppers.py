...
class DualRKF65PseudoStepper(DualEmbeddedPairPseudoStepper):
    pseudo_stepper_name = 'rkf65'
    pseudo_stepper_order = 6
    pseudo_stepper_nregs = 7

    # a_ij coefficients from Fehlberg (1968) NASA TR 287
    a = [
        [1/4],
        # c3 = 3/8
        [3/32,     9/32],
    ...
    # high‐order weights (6th order)
    b = [16/135, 0, 6656/12825, 28561/56430, -9/50, 2/55, 0]

    # low‐order weights (5th order)
    bhat = [25/216, 0, 1408/2565, 2197/4104, -1/5, 0, 0]
